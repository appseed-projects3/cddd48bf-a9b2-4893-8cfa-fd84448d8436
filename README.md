...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-13 18:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cddd48bf-a9b2-4893-8cfa-fd84448d8436.git
$ cd cddd48bf-a9b2-4893-8cfa-fd84448d8436
```
